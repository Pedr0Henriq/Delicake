  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: widget.econfeitaria ==true?Text('Cadastro de Confeitaria',
        style: TextStyle(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () async{
                widget.confeitaria != null ? salvaralteracoes():enviarDados(widget.econfeitaria);
              },
              ...
              child: Text(widget.confeitaria!=null ? 'Salvar':'Cadastrar',style: TextStyle(
                      color: Colors.white,
                      fontSize: 23.0
                    ),)
                  ),
